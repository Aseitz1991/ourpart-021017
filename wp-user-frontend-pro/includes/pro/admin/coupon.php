...
class WPUF_Admin_Coupon {
    ...
    function updated_messages( $messages ) {
        $message = array(
            0  => '',
            1  => __( 'Coupon updated.', 'wpuf' ),
            2  => __( 'Custom field updated.', 'wpuf' ),
            3  => __( 'Custom field deleted.', 'wpuf' ),
            4  => __( 'Coupon updated.', 'wpuf' ),
            5  => isset( $_GET['revision'] ) ? sprintf( __( 'Coupon restored to revision from %s', 'wpuf' ), wp_post_revision_title( ( int ) $_GET['revision'], false ) ) : false,
            6  => __( 'Coupon published.', 'wpuf' ),
            7  => __( 'Coupon saved.', 'wpuf' ),
            8  => __( 'Coupon submitted.', 'wpuf' ),
            9  => '',
            10 => __( 'Coupon draft updated.', 'wpuf' ),
        );
