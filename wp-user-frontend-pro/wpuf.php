...
/**
 * Main bootstrap class for WP User Frontend Pro
 *
...
class WP_User_Frontend {
    ...
    function license_expired() {
        ...
        echo '<p>Your <strong>WP User Frontend Pro Pro</strong> License has been expired. Please <a href="https://wedevs.com/account/" target="_blank">renew your license</a>.</p>';
        echo '</div>';
    }
}
